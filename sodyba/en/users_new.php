...
if (isset($_POST['registruoti_klienta'])) {
    ...
    if (!$error) {
        if (mysqli_query($con, "INSERT INTO users(name, surname, email, password, phone)
        ...
        <div class="col-md-4 col-md-offset-4 well">
            <form role="form" action="<?php echo $_SERVER['PHP_SELF']; ?>" method="post" name="inventoriausforma">
                <fieldset>
                    ...
                    <div class="form-group">
                        <input type="submit" name="registruoti_klienta" value="Register user" class="btn btn-primary" />
                    </div>
                </fieldset>
            </form>
